...
console.log(`
>>> Ready to download some music from YouTube?
>>> This is a program which can download the audio of a specified YouTube video.
>>> It is simple to use, and only requires a few user inputs.
>>> Let's begin!

>>> Navigate to YouTube to find the video you'd like to extract the audio from.
